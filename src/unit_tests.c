...
START_TEST(StrLen_Test) {
  char mas[] = "RICASSO_21\0";
  ck_assert_int_eq(strlen(mas), s21_strlen(mas));

  char mas_2[] = "Ricasso IN \0 SaMaRkAnD1!!!";
...
START_TEST(StrCat_Test) {
  char mas[size] = "";
  char mas_2[size] = "";
  char mas_3[size] = "Ricasso IN SaMaRkAnD1";
  ck_assert_pstr_eq(strcat(mas, mas_3), s21_strcat(mas_2, mas_3));

  char mas_4[size] = "IN";
  char mas_5[size] = "IN";
  char mas_6[size] = " SaMaRkAnD1";
  ck_assert_pstr_eq(strcat(mas_4, mas_6), s21_strcat(mas_5, mas_6));

  char mas_7[size] = "SaMaRkAnD1";
  char mas_8[size] = "SaMaRkAnD1";
  char mas_9[size] = " Ricasso";
...
START_TEST(StrnCat_Test) {
  ...
  count = 3;
  char mas_4[size] = "Ricasso";
  char mas_5[size] = "Ricasso";
  char mas_6[size] = "IN SaMaRkAnD1";
  ck_assert_pstr_eq(strncat(mas_4, mas_6, count),
                    s21_strncat(mas_5, mas_6, count));

  count = 4;
  char mas_7[size] = "Ricasso";
  char mas_8[size] = "Ricasso";
  char mas_9[size] = "PROGRAMMER";
...
START_TEST(StrCmp_Test) {
  ...
  char mas_4[] = "Ricasso PROGRAMMER!";
  char mas_5[] = "Ricasso OF THE PROGRAMMER";
...
START_TEST(StrnCmp_Test) {
  ...
  n = 4;
  char mas_3[] = "Ricasso PROGRAMMER!";
  char mas_4[] = "Ricasso OF THE PROGRAMMER";
  count_1 = s21_strncmp(mas_3, mas_4, n);
  count_2 = strncmp(mas_3, mas_4, n);
  ck_assert_int_eq(count_1, count_2);

  n = 5;
  char mas_5[] = "Ricasso PROGRAMMER IN SaMaRkAnD1!";
  char mas_6[] = "Ricasso ";
  ...
  n = 3;
  char mas_7[] = "Ricasso PROGRAMMER IN SaMaRkAnD1!";
  char mas_8[] = "QARSHI ";
...
START_TEST(MemCmp_Test) {
  ...
  n = 4;
  char mas_3[] = "Ricasso THE PROGRAMMER";
  char mas_4[] = "SCHO OL OF THE PROGRAMMER";
  ck_assert_int_eq(memcmp(mas_3, mas_4, n), s21_memcmp(mas_3, mas_4, n));

  n = 5;
  char mas_5[] = "Ricasso THE PROGRAMMER";
  char mas_6[] = "Ricasso";
...
START_TEST(MemSet_Test) {
  s21_size_t n = 6;
  int ch = '#';
  char mas[] = "Ricasso THE PROGRAMMER";
  char mas_2[] = "Ricasso THE PROGRAMMER";
  ck_assert_pstr_eq(memset(mas, ch, n), s21_memset(mas_2, ch, n));

  n = 4;
  ch = '#';
  char mas_3[] = "PROGRAMMER";
  char mas_4[] = "PROGRAMMER";
  ck_assert_pstr_eq(memset(mas_3, ch, n), s21_memset(mas_4, ch, n));

  n = 5;
  ch = '#';
  char mas_5[] = "SaMaRkAnD1";
  char mas_6[] = "SaMaRkAnD1";
...
START_TEST(StrCpy_Test) {
  char mas[size] = "";
  char mas_1[size] = "";
  char mas_2[size] = "Ricasso THE PROGRAMMER";
  ck_assert_pstr_eq(strcpy(mas, mas_2), s21_strcpy(mas_1, mas_2));

  char mas_3[size] = "";
  char mas_4[size] = "";
  char mas_5[size] = "Ricasso THE \0PROGRAMMER";
  ck_assert_pstr_eq(strcpy(mas_3, mas_5), s21_strcpy(mas_4, mas_5));

  char mas_6[size] = "Ricasso ";
  char mas_7[size] = "Ricasso ";
  char mas_8[size] = "THE PROGRAMMER";
...
START_TEST(StrnCpy_Test) {
  s21_size_t n = 3;
  char mas[size] = "Ricasso ";
  char mas_1[size] = "Ricasso ";
  char mas_2[size] = "THE PROGRAMMER";
  ck_assert_pstr_eq(strncpy(mas, mas_2, n), s21_strncpy(mas_1, mas_2, n));

  n = 5;
  char mas_3[size] = "SaMaRkAnD1";
  char mas_4[size] = "SaMaRkAnD1";
  char mas_5[size] = "";
  ...
  char mas_6[size] = "77";
  char mas_7[size] = "77";
  char mas_8[size] = "SaMaRkAnD1\0Ricasso";
...
START_TEST(MemCpy_Test) {
  ...
  char mas[] = "THE";
  char mas_1[] = "THE";
  char mas_2[] = "    PROGRAMMER";
  ck_assert_pstr_eq(memcpy(mas, mas_2, n), s21_memcpy(mas_1, mas_2, n));

  n = 5;
  char mas_3[] = "SaMaRkAnD1";
  char mas_4[] = "SaMaRkAnD1";
  char mas_5[size] = "";
...
START_TEST(MemMove_Test) {
  s21_size_t n = 3;
  char mas[] = "RICASSO PROGRAMMER IN SaMaRkAnD1";
  char mas_2[] = "RICASSO PROGRAMMER IN SaMaRkAnD1";
...
START_TEST(MemChr_Test) {
  char mas[] = "Ricasso P\0ROGRaMMING\0";
  ck_assert_pstr_eq(memchr(mas, 'a', 5), s21_memchr(mas, 'a', 5));

  char mas_2[] = "Ricasso CUP UFC";
...
START_TEST(StrChr_Test) {
  char mas[] = "Hello Ricasso";
  ck_assert_pstr_eq(strchr(mas, ' '), s21_strchr(mas, ' '));

  char mas_2[] = "Ricasso_PROGRAMMER\0 in SaMaRkAnD1";
  ck_assert_pstr_eq(strchr(mas_2, 'm'), s21_strchr(mas_2, 'm'));

  char mas_3[] = "Ricasso PROGRAMMER in SaMaRkAnD1";
...
START_TEST(StrrChr_Test) {
  ...
  char mas_2[] = "Ricasso programm@ing in SaMaRkAnD1";
  ck_assert_pstr_eq(strrchr(mas_2, '@'), s21_strrchr(mas_2, '@'));

  char mas_3[] = "Ricasso programm@ing in SaMaRkAnD1";
  ck_assert_pstr_eq(strrchr(mas_3, 'g'), s21_strrchr(mas_3, 'g'));

  char mas_4[] = "Ricasso. PROGRAMMER in SaMaRkAnD1";
...
START_TEST(To_Up_Test) {
  char mas[] = "ricasso in samarkand1";
  char *mas_2 = s21_to_upper(mas);
  ck_assert_pstr_eq(mas_2, "RICASSO IN SAMARKAND1");
  free(mas_2);
...
START_TEST(Sprintf_Test_s) {
  ...
  int_test1 = s21_sprintf(str_1, "%-15s", "helloRicasso");
  int_test2 = sprintf(str_2, "%-15s", "helloRicasso");
  ck_assert_str_eq(str_1, str_2);
  ck_assert_int_eq(int_test1, int_test2);
  int_test1 = 0;
  int_test2 = 0;
